...
@section('content')
    ...
    <!-- Post Creation Form -->
    <form action="{{ route('customer.post.store') }}" method="POST" enctype="multipart/form-data" class="mb-6">
        @csrf
        ...
        <div class="mb-4">
            <label for="visibility" class="block text-gray-700">Tags</label>
            <select name="visibility" class="w-full p-2 border rounded">
