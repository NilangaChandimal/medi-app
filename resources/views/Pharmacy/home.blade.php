    ...
    <div class="bg-white dark:bg-gray-800 rounded-2xl shadow-xl overflow-hidden border border-gray-100 dark:border-gray-700">
        <div class="p-6">
            ...
            @foreach($chats as $chat)
                <a href="{{ route($userType . '.chats.show', $chat->id) }}" class="block hover:bg-gray-50 dark:hover:bg-gray-700 p-2 -m-2 rounded-xl transition duration-200">
            @endforeach
            @endif
...
<div id="mediaModal" class="fixed inset-0 bg-gray-900 bg-opacity-75 flex items-center justify-center hidden" onclick="outsideClickClose(event)">
    <div class="bg-white rounded-lg overflow-hidden shadow-lg max-w-2xl w-full p-4 relative" onclick="event.stopPropagation()">
