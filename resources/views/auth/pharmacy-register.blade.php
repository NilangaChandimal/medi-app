        ...
        <div class="bg-white shadow-2xl rounded-lg py-8 px-6">
            ...
            <form method="POST" action="{{ route('pharmacy.register') }}" enctype="multipart/form-data" class="space-y-6">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div>
                        <label for="registration_number" class="block text-sm font-medium text-gray-700">Register Number</label>
                    ...
                    <div>
                        ...
                        <textarea id="license_details" name="license_details" type="text" required
                               class="mt-1 block w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-blue-500 text-sm"
                ...
                <div class="text-center text-sm">
                    <p class="text-gray-600">
                        ...
                        <a href="{{ route('pharmacy.login') }}" class="font-medium text-blue-600 hover:text-blue-500 transition duration-150 ease-in-out">
                            Sign in
                        </a>
                    </p>
                </div>
